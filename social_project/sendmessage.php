...
$sql1="SELECT last FROM members WHERE id='$id'";
...
$sql27="SELECT first from members WHERE id='$id'";
...
<form method="post" action="sentmessage.php?id=<?php echo("$id"); ?>">
<table width="680" border="0" align="left" cellpadding="3" cellspacing="10" background="/images/white.jpg">
<tr>
<td width="400" height="50"><font face="Cracked Johnnie" color="black" size="5"><b>Send Message To <?php echo  ($username); echo('&nbsp;'); echo($last);?></b>
</td></tr><tr><td><font color="red"><?php echo"{$_SESSION['$certificate']}";?></font></td></tr>
<tr><td align="center">
<textarea name="message" rows="20" cols="50"></textarea>
</td></tr>
<tr><td align="center" height="50"><input type="submit" value="Send Message"></td></tr>
