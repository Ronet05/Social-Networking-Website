...
$folder=mysql_result($res118, $row);
 ...
 $sql1="SELECT first FROM members WHERE  id='$id'";
...
$sql2="SELECT last FROM members WHERE  id='$id'";
...
$sql9="SELECT current FROM profile WHERE id='$id'";
...
<tr>
<td align="left" height="10">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="wall.php?id=<?php echo("$id"); ?>" style=text-decoration:none><font face="Cracked Johnnie" color="black" size="2">Wall</font>
</tr>
<tr>
