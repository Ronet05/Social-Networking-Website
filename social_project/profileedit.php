...
<td height="200" align="right"><br><img src="<?php echo"$folder$image";?>" height="180" width="150"><br><a href="changepic.php"  style=text-decoration:none><font color="black">Change Photo</font></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
...
<table width="500">
   ...
   <td><font color="black"><b>Employer</b></font></td>
    <td><input type="text" name="text1" value="<?php echo("$company"); ?>"></font></td>
</tr><tr>   
<td><font color="black"><b>College<b></font></td>
     <td><input type="text" name="text2" value="<?php echo("$college"); ?>"></td>
     </tr>
      <tr>   
<td><font color="black"><b>School<b></font></td>
     <td><input type="text" name="text3" value="<?php echo("$school"); ?>"></td>
     </tr>
    </table>
...
<tr><td>
   ...
   <td><font color="black"><b>Favourite Quote</b></font></td>
    <td><input type="text" name="text4" value="<?php echo("$challenge"); ?>"></td>
     </tr>
    </table>
</td>
</tr>
...
<tr><td>
   ...
   <td><font color="black"><b>Favourite Song</b></font></td>
    <td><input type="text" name="text5" value="<?php echo("$song"); ?>"></td>
     </tr>
    <tr>
   <td><font color="black"><b>Favourite Book</b></font></td>
    <td><input type="text" name="text6" value="<?php echo("$book"); ?>"></td>
     </tr>
    <tr>
   <td><font color="black"><b>Favourite Movie</b></font></td>
    <td><input type="text" name="text7" value="<?php echo("$movie"); ?>"></td>
     </tr>
   </table>
</td>
</tr>
...
<tr><td>
   ...
   <td><font color="black"><b>Favourite Sports</b></font></td>
    <td><input type="text" name="text8" value="<?php echo("$sports"); ?>"></td>
 </tr><tr>    
<td><font color="black"><b>TV Serials<b></font></td>
<td><input type="text" name="text9" value="<?php echo("$tv");?>"></td>
</tr>
    </table>
</td>
</tr>
...
<tr><td>
     <table width="500">
<tr>
   <td><font color="black"><b>Home city</b></font></td>
    <td><input type="text" name="text18" value="<?php echo("$home"); ?>"></td>
 </tr>    
<tr>
   <td><font color="black"><b>Current city</b></font></td>
    <td><input type="text" name="text17" value="<?php echo("$current"); ?>"></td>
 </tr>  


<tr>
   <td><font color="black"><b>About You</b></font></td>
    <td><input type="text" name="text10" value="<?php echo("$about"); ?>"></td>
 </tr><tr>    
<td><font color="black"><b>Interested in<b></font></td>
<td><input type="text" name="text11" value="<?php echo("$interested"); ?>"></td>
</tr>
    <tr>    
<td><font color="black"><b>Relationship<b></font></td>
<td><input type="text" name="text12" value="<?php echo("$relationship"); ?>"></td>
</tr>
<tr>    
...
<td><input type="text" name="text15" value="<?php echo("$website");?>"></td>
</tr>
    <tr>    
<td><font color="black"><b>Phone number<b></font></td>
<td><input type="text" name="text16" value="<?php echo("$phone");?>"></td>
</tr>
<tr>    
<td>&nbsp;</td>
